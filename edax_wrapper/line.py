...
class Line:
    ...
    def __init__(self, string: str):
        ...
        self.confidence = self.selectivity_to_confidence(self.selectivity)
    ...
    @staticmethod
    def selectivity_to_confidence(selectivity: int|None) -> float:
        ...
        if selectivity == 99:
            return 3.3
        raise RuntimeError("Selectivity unknown.")
